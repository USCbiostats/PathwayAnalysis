...
We will start with one vertex and then iterate the following untit the graph is big enough
...
plot(oldnet, edge.arrow.size=.2, edge.curved=0,
     vertex.color="red", vertex.frame.color="#555555",
...
Write a function to calculate Moran's (global) I. Reminder: Moran's-I is defined as \[ I=\frac{N}{W}\frac{\sum_i \sum_j w_{ij} (x_i-\bar{x})(x_j-\bar{x})}{\sum_i(x_i-\bar{x})^2} \]
...
That didn't seem to show much difference! So let's try something else. 

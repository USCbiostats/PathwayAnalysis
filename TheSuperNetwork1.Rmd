...
plot(newnet, vertex.color=ifelse(V(newnet)==FocalNode,"blue","red"), vertex.label.dist=2.5,edge.arrow.size=0.3,vertex.label.cex=0.2,vertex.size= as.numeric(ifelse(V(newnet)$MyAttribute < 0,"0.1",V(newnet)$MyAttribute)),main="Subgraph showing attribute values")
...
plot(NewSub,vertex.label=V(NewSub)$MyID,vertex.label.cex=0.4,edge.arrow.size=0.3,main="Subgraph")
...
plot(net2, edge.arrow.size=.3,  vertex.size= as.numeric(ifelse(V(newnet)$MyAttribute < 0,"0.1",V(newnet)$MyAttribute)),main="original attributes",vertex.label.cex=0.2)
...
plot(net2, edge.arrow.size=.5,  vertex.label.cex=0.2, vertex.size= as.numeric(ifelse(V(newnet)$MyAttribute < 0,"0.1",V(newnet)$MyAttribute)),main="attributes of permuted network")
